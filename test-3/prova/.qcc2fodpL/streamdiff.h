...
[`advection.h`](/src/advection.h) and the implicit diffusion scheme in [`diffusion.h`](/src/diffusion.h). The equation for the streamfunction
...
event velocity (i++)
{
  const face vector c[] = {mu, mu};
  
  mgd = diffusion (omega, dt, c);
